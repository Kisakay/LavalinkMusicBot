...
class BlowjobCommand : Command {
    override val name: String = "blowjob"
    ...
    override val aliases: Array<String> = arrayOf("grosse-pute-qui-suce", "suce")
    ...
    override suspend fun execute(
        ...
        val apiUrl = "https://nekobot.xyz/api/image?type=blowjob"
