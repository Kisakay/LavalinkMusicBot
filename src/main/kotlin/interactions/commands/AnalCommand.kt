...
class AnalCommand : Command {
    override val name: String = "anal"
    ...
    override val aliases: Array<String> = arrayOf("cul", "q")
...
//        }
        ...
        val nsfwPng: NsfwContent = Json.decodeFromString(apiResponse)
